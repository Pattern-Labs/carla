...
#define LOCTEXT_NAMESPACE "RoadRunnerDatasmithBPLibrary"
...
FString UDatasmithRoadRunnerTypeFetcher::Fetch_Implementation(const UObject* Object, bool& bOutFetchSucceded) const
{
	if (Object)
	{
		bOutFetchSucceded = true;
		return UDatasmithContentBlueprintLibrary::GetDatasmithUserDataValueForKey(const_cast<UObject*>(Object), "Type");
	}
...
FText UDatasmithRoadRunnerTypeFetcher::GetNodeDisplayFetcherName_Implementation() const
{
	return LOCTEXT("NodeDisplayFetcher_MetadataValue", "RoadRunnerType");
}

////////////////////////////////////////////////////////////////////////////////

bool UDatasmithRoadRunnerTypeFetcher::IsThreadSafe() const
{
	return true;
}
